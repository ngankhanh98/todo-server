...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "2f479141a14464d02ce1";
...
AuthModule = __decorate([
    common_1.Module({
        imports: [
            ...
            jwt_1.JwtModule.register({ secret: constant_1.secret.passphrase }),
        ],
...
const user_entity_1 = __webpack_require__(13);
const functions_1 = __webpack_require__(17);
const jwt_1 = __webpack_require__(12);
let AuthService = class AuthService {
    ...
    async validateUser(user) {
        ...
        if (users.length) {
            try {
                const result = await functions_1.compare(user.password, users[0].password);
                return result;
            }
            catch (error) {
                throw Error(error);
...
const common_1 = __webpack_require__(7);
const database_providers_1 = __webpack_require__(24);
const typeorm_1 = __webpack_require__(14);
...
const typeorm_1 = __webpack_require__(11);
const common_1 = __webpack_require__(7);
const verify_middleware_1 = __webpack_require__(26);
const user_entity_1 = __webpack_require__(13);
const user_controller_1 = __webpack_require__(27);
const user_service_1 = __webpack_require__(30);
let UserModule = class UserModule {
    configure(consumer) {
        consumer.apply(verify_middleware_1.VerifyMiddleware).forRoutes(user_controller_1.UserController);
    }
};
...
let UserController = class UserController {
    ...
    async register(user) {
        return await class_transformer_1.plainToClass(user_dto_1.getUserDTO, this.userService.create(user));
    }
    async getDetail(req) {
        const { username } = req;
